...
#SBATCH --job-name=AncCondFig5Job      #Set the job name to "JobExample1"
...
#SBATCH --output=AncCondFig5Job.%j      #Send stdout/err to "Example1Out.[jobID]"
...
Rscript HPRCAncCondTestScriptFIG5.R
