...
#SBATCH --job-name=AncCondFig3Job      #Set the job name to "JobExample1"
#SBATCH --time50:00:00              #Set the wall clock limit to 1hr and 30min 
#SBATCH --nodes=1                    #Request 1 node
#SBATCH --ntasks-per-node=28          #Request 8 tasks/cores per node
#SBATCH --mem=25600M                  #Request 2560MB (2.5GB) per node
#SBATCH --output=AncCondFig3Job.%j      #Send stdout/err to "Example1Out.[jobID]"
...
Rscript HPRCAncCondTestScriptFIG3.R
