...
#SBATCH --job-name=AncCondFig2Job      #Set the job name to "JobExample1"
...
#SBATCH --output=AncCondFig2Job.%j      #Send stdout/err to "Example1Out.[jobID]"
...
Rscript HPRCAncCondTestScriptFIG2.R
